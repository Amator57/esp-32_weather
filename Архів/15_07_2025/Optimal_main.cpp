...
// Очистити старі файли логів (3 дні) рядок 1090
// Функціонуюча версія. Запис, збереження архівів, видалення старих архівів. Видалено закоментовані блоки коду.
#include <WiFi.h>
#include <SPIFFS.h>
