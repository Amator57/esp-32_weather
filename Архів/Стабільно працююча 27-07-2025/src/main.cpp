// Блок ОНОВЛЕННЯ ДАНИХ СЕНСОРІВ ТА ЗБЕРЕЖЕННЯ В ІСТОРІЮ рядок 1241
// Очистити старі файли логів (3 дні)  clearOldLogs(3) - 1227; рядок 575  clearOldLogs(2)
#include <WiFi.h>
#include <SPIFFS.h>
...
void saveHistoryTask(void *parameter) {
  archivingInProgress = true;//додано 25.07.2025
...
//+++++++++++++++++++++++++++++++++
 ...
 } //End АРХІВАЦІЯ ≥ 23:58 (один раз на добу)
//+++++++++++++++++++++++++++++++++
 ...
 if (timeOnly >= "00:01" && !fileCreated && today != lastInitDate) {
  ...
  fileCreated = true;
  lastInitDate = today;
 } //End cтворення нового CSV ≥ 00:01
 //+++++++++++++++++++++++++++++++++
 // ==============================
...
if (!archivingInProgress && clearAfterSaveTriggered) {
  ...
  clearOldLogs(3);  // залишає лише останні 3 дні
